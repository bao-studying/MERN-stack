    ...
    <Modal show={show} onHide={handleClose} centered className="eco-modal">
      ...
      <Modal.Body className="p-4">
        ...
        <div className="text-center mb-4">
          <div
            className="category-img-preview border rounded-3 d-flex align-items-center justify-content-center mx-auto position-relative bg-light overflow-hidden"
            style={{
              width: "120px",
              height: "120px",
